...
import { createContext, useMemo, useReducer, useCallback, useContext, useEffect, useState, useId, useRef } from 'react';
...
function GuideProvider({ children, components }) {
  ...
  return /* @__PURE__ */ jsx(GuideContext.Provider, { value, children });
}
function useGuide() {
...
var twMerge = extendTailwindMerge({ prefix: "crg-" });
function cn(...inputs) {
...
function GuideOverlay() {
  ...
  if (searching) {
    return createPortal(
      /* @__PURE__ */ jsx("div", { className: loadingClass, style: { zIndex: Z_TOOLTIP }, children: "\uD654\uBA74\uC744 \uC900\uBE44\uD558\uACE0 \uC788\uC2B5\uB2C8\uB2E4..." }),
      document.body
    );
  }
  if (timedOut) {
    return createPortal(
      /* @__PURE__ */ jsxs("div", { className: loadingClass, style: { zIndex: Z_TOOLTIP }, children: [
        /* @__PURE__ */ jsx("div", { className: "crg-mb-4", children: "\uC694\uC18C\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4" }),
        /* @__PURE__ */ jsxs("div", { className: "crg-flex crg-justify-end crg-gap-2", children: [
    ...
    /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          style: tooltipStyle,
          children: [
            /* @__PURE__ */ jsxs("div", { className: "crg-flex crg-justify-between crg-items-center crg-mb-3", children: [
              /* @__PURE__ */ jsxs("span", { className: "crg-text-[13px] crg-text-subtle crg-font-semibold", children: [
                currentStepIndex + 1,
                " / ",
                steps.length
              ] }),
              cancelable && /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "icon", onClick: cancel, "aria-label": "\uAC00\uC774\uB4DC \uB2EB\uAE30", children: "\u2715" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "crg-text-[15px] crg-leading-relaxed crg-text-foreground crg-mb-4", children: currentStep?.message }),
            hint && /* @__PURE__ */ jsx("div", { className: "crg-text-[13px] crg-text-brand crg-mb-3 crg-font-medium", children: hint }),
            showNav && /* @__PURE__ */ jsxs("div", { className: "crg-flex crg-justify-end crg-gap-2", children: [
...
var BottomSheetOverlay = React6.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
...
var BottomSheetContent = React6.forwardRef(({ className, children, title, srDescription, hideClose, ...props }, ref) => /* @__PURE__ */ jsxs(DialogPrimitive.Portal, { children: [
  /* @__PURE__ */ jsx(BottomSheetOverlay, {}),
  /* @__PURE__ */ jsxs(
    DialogPrimitive.Content,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("div", { className: "crg-flex crg-justify-center crg-pt-[10px] crg-pb-[6px]", children: /* @__PURE__ */ jsx("div", { className: "crg-h-[4px] crg-w-[44px] crg-rounded-full crg-bg-border" }) }),
        /* @__PURE__ */ jsxs("div", { className: "crg-flex crg-items-center crg-justify-between crg-px-[20px] crg-pb-[12px]", children: [
          /* @__PURE__ */ jsx(DialogPrimitive.Title, { asChild: true, children: /* @__PURE__ */ jsx("span", { className: "crg-text-[16px] crg-leading-[24px] crg-font-bold crg-text-foreground", children: title ?? "\xA0" }) }),
          !hideClose ? /* @__PURE__ */ jsx(DialogPrimitive.Close, { asChild: true, children: /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              "aria-label": "\uB2EB\uAE30",
              ...
              children: /* @__PURE__ */ jsx(CloseGlyph, { size: 20 })
            }
          ) }) : null
        ] }),
        srDescription ? /* @__PURE__ */ jsx(DialogPrimitive.Description, { className: "crg-sr-only", children: srDescription }) : null,
        /* @__PURE__ */ jsx("div", { className: "crg-flex-1 crg-min-h-0 crg-flex crg-flex-col", children })
      ]
    }
  )
] }));
...
var SelectTrigger = React6.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
  SelectPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx(SelectPrimitive.Icon, { asChild: true, children: /* @__PURE__ */ jsx("span", { className: "crg-text-icon", children: /* @__PURE__ */ jsx(ChevronDownIcon, { size: 16 }) }) })
    ]
  }
));
SelectTrigger.displayName = SelectPrimitive.Trigger.displayName;
var SelectContent = React6.forwardRef(
  ({ className, children, position = "popper", sideOffset = 6, ...props }, ref) => /* @__PURE__ */ jsx(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsx(
    SelectPrimitive.Content,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx(SelectPrimitive.Viewport, { className: "crg-p-[6px]", children })
    }
  ) })
);
...
var SelectItem = React6.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
  SelectPrimitive.Item,
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("span", { className: "crg-inline-flex crg-h-[16px] crg-w-[16px] crg-items-center crg-justify-center crg-text-brand", children: /* @__PURE__ */ jsx(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx(CheckIcon, { size: 16 }) }) }),
      /* @__PURE__ */ jsx(SelectPrimitive.ItemText, { asChild: true, children: /* @__PURE__ */ jsx("span", { className: "crg-flex-1 crg-truncate crg-text-left", children }) })
    ]
  }
));
          ...
          children: [
            ...
            onOpenDocument ? /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(DocumentIcon, { size: 16 }),
                  "\uAD00\uB828 \uBB38\uC11C \uBCF4\uAE30"
                ]
              }
            ) : null
...
function Chatbot(props) {
  ...
  const renderViewerBody = (closeButton) => /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        style: {
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { style: { flex: 1, minWidth: 0, maxWidth: "420px" }, children: /* @__PURE__ */ jsxs(
                  Select,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(SelectTrigger, { "aria-label": "\uAD00\uB828 \uBB38\uC11C \uC120\uD0DD", className: "crg-w-full", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "\uAD00\uB828 \uBB38\uC11C\uB97C \uC120\uD0DD\uD558\uC138\uC694", children: selectedVersion ? selectedVersion.label : void 0 }) }),
                      /* @__PURE__ */ jsx(SelectContent, { children: versions.map((v) => /* @__PURE__ */ jsx(SelectItem, { value: v.id, children: v.label }, v.id)) })
                    ]
                  }
                ) })
              ]
    ...
    selectedAnswer ? /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs(
                  Select,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(SelectTrigger, { "aria-label": "\uBE44\uAD50 \uAE30\uC900 \uC774\uB825", children: /* @__PURE__ */ jsx(SelectValue, { children: diffFromVersion ? `${diffFromVersion.label}${diffFromVersion.updatedAt ? ` \xB7 ${diffFromVersion.updatedAt}` : ""}` : void 0 }) }),
                      /* @__PURE__ */ jsx(SelectContent, { children: revisionTimeline.map((v) => /* @__PURE__ */ jsxs(SelectItem, { value: v.id, children: [
                        v.label,
                ...
                /* @__PURE__ */ jsxs(
                  Select,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(SelectTrigger, { "aria-label": "\uBE44\uAD50 \uB300\uC0C1 \uC774\uB825", children: /* @__PURE__ */ jsx(SelectValue, { children: diffToVersion ? `${diffToVersion.label}${diffToVersion.updatedAt ? ` \xB7 ${diffToVersion.updatedAt}` : ""}` : void 0 }) }),
                      /* @__PURE__ */ jsx(SelectContent, { children: revisionTimeline.map((v) => /* @__PURE__ */ jsxs(SelectItem, { value: v.id, children: [
                        v.label,
                        v.updatedAt ? ` \xB7 ${v.updatedAt}` : ""
                      ] }, v.id)) })
          ...
          ) : /* @__PURE__ */ jsx("span", { children: selectedVersion?.updatedAt ? `\uCD5C\uC885 \uC218\uC815 ${selectedVersion.updatedAt}` : selectedVersion?.label ?? "" }),
          isHistoryMode ? /* @__PURE__ */ jsxs(
            "div",
            {
              style: {
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: !selectedAnswer ? /* @__PURE__ */ jsx(
          "div",
          {
            style: {
              padding: "48px 0",
          ...
          highlightSentences.length > 0 ? /* @__PURE__ */ jsx(
            TestHighlight,
            {
              containerId,
  ...
  const viewerCloseButton = /* @__PURE__ */ jsx(
    "button",
    {
      type: "button",
      "aria-label": "\uBB38\uC11C \uB2EB\uAE30",
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        showFloatingButton ? /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            ...
            children: isOpen ? /* @__PURE__ */ jsx(CloseIcon, { size: 24 }) : /* @__PURE__ */ jsx(ChatIcon, { size: 28 })
          }
        ) : null,
        /* @__PURE__ */ jsxs(
          "div",
              ...
              /* @__PURE__ */ jsxs(
                "section",
                {
                  ...
                  children: [
                        ...
                        children: /* @__PURE__ */ jsxs(
                          "div",
                          {
                            ...
                            children: [
                              ...
                              messages.map((msg) => {
                                ...
                                return /* @__PURE__ */ jsxs(
                                  Bubble,
                                  {
                                    ...
                                    children: [
                                      renderedText,
                                      renderedImages.map((imageSrc) => /* @__PURE__ */ jsx(
                                        "img",
                                        {
                                          src: imageSrc,
                                          alt: "",
                              ...
                              /* @__PURE__ */ jsx("div", { ref: scrollAnchorRef })
                            ]
                          }
                        )
                      }
                    ),
                    showSuggestions && !fetchSuggestions && messages.length === 0 && answers.length > 0 ? /* @__PURE__ */ jsx(
                      "div",
                      {
                        style: {
                          display: "flex",
                        ...
                        children: answers.map((a) => /* @__PURE__ */ jsx(
                          "button",
                          {
                            type: "button",
                    ...
                    fetchSuggestions && suggestOpen && suggestions.length > 0 ? /* @__PURE__ */ jsx(
                      "div",
                      {
                        role: "listbox",
                        "aria-label": "\uCD94\uCC9C \uC9C8\uBB38",
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx(
                            "button",
                            {
                              ...
                              children: /* @__PURE__ */ jsx(SendIcon, { size: 20 })
                            }
                          )
                        ]
                      }
...
export { Chatbot, GUIDE_TARGETS, GuideNotification, GuideOverlay, GuideProvider, TEST_HIGHLIGHT_CLASS, TestHighlight, defaultMatchAnswer, parseGuideResponse, testHighlight, useGuide, validateGuideJson };
